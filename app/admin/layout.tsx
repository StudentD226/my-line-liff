      ...
      >
        ...
        <div className="p-5 border-t border-slate-100 shrink-0">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-red-50 hover:bg-red-500 text-red-600 hover:text-white p-3.5 rounded-xl font-bold transition-all active:scale-95 border border-red-100 hover:border-red-500"
          >
            <LogOut size={20} />
